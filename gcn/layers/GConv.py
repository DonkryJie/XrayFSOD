...
class MConv(_ConvNd):
    ...
    def forward(self, x):
        # print('x1: ', x.shape)  # [3, 2, 28, 28]
        if self.expand:
            x = self.do_expanding(x)

        # print('x2: ', x.shape)  # [3, 8, 28, 28]

        # print('self.weight: ', self.weight.shape)  # [10, 2, 4, 3, 3]

        # print('self.MFilters: ', self.MFilters.shape)  # [4, 3, 3]
        ...
        # print('x3: ', x.shape)  # [3, 8, 28, 28]
        # print('new_weight: ', new_weight.shape)  # [40, 8, 3, 3]
...
def getGaborFilterBank(nScale, M, h, w):
    ...
    # print('gfilter_real: ', gfilter_real)
    return gfilter_real