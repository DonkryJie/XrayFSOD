...
class PascalVOCDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, split, use_difficult=False, transforms=None, toofew=True):
        ...
        self._imgpath_mask = os.path.join(self.root, "mask", "%s.jpg")
        # self._imgpath_mask = os.path.join(self.root, "edge_fore", "%s_edge_foreground_edges.png")
    ...
    def __getitem__(self, index):
        ...
        mask = Image.open(self._imgpath_mask % img_id)
        # print(self._imgpath_mask % img_id)
        target = self.get_groundtruth(index)
        target = target.clip_to_image(remove_empty=True)

        # datasets/voc/VOC2007/JPEGImages/xray_23287.png

        # mask = Image.open('/home/hl/xray_01511_mask22.png')
