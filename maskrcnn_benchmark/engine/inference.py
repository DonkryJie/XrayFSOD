...
def compute_on_dataset(oneStage, model, data_loader, device, timer=None):
    model.eval()
    results_dict = {}
...
def inference(oneStage,
    ...
    total_timer.tic()
    predictions = compute_on_dataset(oneStage, model, data_loader, device)
